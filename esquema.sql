...
CREATE TABLE EVENTO(
    ...
    LATITUDE FLOAT NOT NULL, --+OU-XX.XXXXXX
    LONGITUDE FLOAT NOT NULL, --+OU-XX.XXXXXX
...
CREATE SEQUENCE EVENTO_SEQ --SEQUENCE PARA INCREMENTAR OS ID AUTOMATICAMENTE COMEÇANDO DO ZERO 
  MINVALUE 0
  START WITH 0
  INCREMENT BY 1
  CACHE 20;
...
CREATE TABLE OCORRENCIA (
    ID INT NOT NULL, 
    DATA_E_HORA TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    LATITUDE FLOAT NOT NULL, --+OU-XX.XXXXXX
    LONGITUDE FLOAT NOT NULL, --+OU-XX.XXXXXX
...
CREATE SEQUENCE OCORRENCIA_SEQ --SEQUENCE PARA INCREMENTAR OS ID AUTOMATICAMENTE COMEÇANDO DO ZERO
  MINVALUE 0
  START WITH 0
  INCREMENT BY 1
  CACHE 20;
...
CREATE TABLE CONTRATADO(
    GUARDA CHAR(11),
    EVENTO INT,
    STATUS INT DEFAULT 0 NOT NULL,  --0(PENDENTE), 1(ACEITO), 2(RECUSADO)
...
CREATE SEQUENCE PONTO_EST_SEQ --SEQUENCE PARA INCREMENTAR OS ID AUTOMATICAMENTE COMEÇANDO DO ZERO
  MINVALUE 0
  START WITH 0
  INCREMENT BY 1
  CACHE 20;
...
CREATE SEQUENCE POST_SEQ --SEQUENCE PARA INCREMENTAR OS ID AUTOMATICAMENTE COMEÇANDO DO ZERO
  MINVALUE 0
  START WITH 0
  INCREMENT BY 1
  CACHE 20;
...
CREATE TABLE POST_OCORRENCIA (
    ...
    CONSTRAINT FK_OCORRENCIA_POST_OCORRENCIA FOREIGN KEY (OCORRENCIA)
               ...
               ON DELETE CASCADE,
    CONSTRAINT FK_POST_POST_OCORRENCIA FOREIGN KEY (POST)
               REFERENCES POST(ID)
               ON DELETE CASCADE
);
...
CREATE TABLE POST_EVENTO (
    ...
    CONSTRAINT FK_EVENTO_POST_EVENTO FOREIGN KEY (EVENTO)
               REFERENCES EVENTO(ID)
               ON DELETE CASCADE,
    CONSTRAINT FK_POST_POST_EVENTO FOREIGN KEY (POST)
               REFERENCES POST(ID)
               ON DELETE CASCADE
);
...
CREATE TABLE POST_PONTO_ESTRATEGICO (
    ...
    CONSTRAINT FK_POST_POST_PE FOREIGN KEY (POST)
               REFERENCES POST(ID)
               ON DELETE CASCADE,
...
CREATE SEQUENCE COMENTARIO_SEQ --SEQUENCE PARA INCREMENTAR OS ID AUTOMATICAMENTE COMEÇANDO DO ZERO
  MINVALUE 0
  START WITH 0
  INCREMENT BY 1
  CACHE 20;
...
CREATE TABLE ORGANIZACOES_DE_SERVICOS(
    CNPJ CHAR(14) NOT NULL, --XXXXXXXX0001XX
    NOME VARCHAR2(50) NOT NULL,

    CONSTRAINT PK_ORGANIZACOES_DE_SERVICOS PRIMARY KEY (CNPJ)
);

CREATE TABLE ESTRUTURAL (
    ID INT NOT NULL, 
    ORGAO CHAR(14), --XXXXXXXX0001XX
